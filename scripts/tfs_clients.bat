...
set HTTPS_PROXY=
if /I %1==TEST (
    .\\node_modules\\.bin\\cypress run --quiet --spec cypress/e2e/clients/%3.js --env currentEnv=%1,isAviva=%2 --reporter cypress-mochawesome-reporter --reporter-options "reportDir=cypress/reports/clients, inlineAssets=true, charts=true, embeddedScreenshots=true, reportPageTitle='clients'"
) else (
