...
if (Cypress.env('isAviva'))
    describe('AVIVA - Matrix Web : Navigazioni da BackOffice', function () {
        ...
        it('AVIVA - Verifica atterraggio Nuova incentivazione Vita(News)', function () {
            TopBar.clickBackOffice()
            BackOffice.clickNewsLanding()
            BackOffice.backToBackOffice()
        });

        it('AVIVA - Verifica links Sinistri', function () {
            TopBar.clickBackOffice()
            BackOffice.checkLinksOnSinistriExist()
        });

        it('AVIVA - Verifica links Contabilità', function () {
            TopBar.clickBackOffice()
            BackOffice.checkLinksOnContabilitaExist()
        });

        it('AVIVA - Verifica apertura disambiguazione: Movimentazione Sinistri', function () {
            TopBar.clickBackOffice()
            BackOffice.clickCardLink('Movimentazione sinistri')
            BackOffice.backToBackOffice()
        })

        it('AVIVA - Verifica apertura disambiguazione: Consultazione sinistri', function () {
            TopBar.clickBackOffice()
            BackOffice.clickCardLink('Consultazione sinistri')
            BackOffice.backToBackOffice()
        })

        it('AVIVA - Verifica apertura disambiguazione: Sintesi Contabilità', function () {
            TopBar.clickBackOffice()
            BackOffice.clickCardLink('Sintesi Contabilità')
            BackOffice.backToBackOffice()
        })
        it('AVIVA - Verifica apertura disambiguazione: Giornata contabile', function () {
            TopBar.clickBackOffice()
            BackOffice.clickCardLink('Giornata contabile')
            BackOffice.backToBackOffice()
        })

        //! DA AGGIUNGERE SU TFS () 19TC su BackOffice
        it('AVIVA - Verifica apertura disambiguazione: Consultazione Movimenti', function () {
            TopBar.clickBackOffice()
        ...
        it('AVIVA - Verifica apertura disambiguazione: Estrazione Contabilità', function () {
            TopBar.clickBackOffice()
        ...
        it('AVIVA - Verifica apertura disambiguazione: Deleghe SDD', function () {
            TopBar.clickBackOffice()
        ...
        it('AVIVA - Verifica apertura disambiguazione: Quadratura unificata', function () {
            TopBar.clickBackOffice()
            BackOffice.clickCardLink('Quadratura unificata')
            BackOffice.backToBackOffice()
        })

        it('AVIVA - Verifica apertura disambiguazione: Incasso per conto', function () {
            TopBar.clickBackOffice()
        ...
        it('AVIVA - Verifica apertura disambiguazione: Incasso massivo', function () {
            TopBar.clickBackOffice()
            BackOffice.clickCardLink('Incasso massivo')
            BackOffice.backToBackOffice()
        })

        it('AVIVA - Verifica apertura disambiguazione: Sollecito titoli', function () {
            TopBar.clickBackOffice()
            BackOffice.clickCardLink('Sollecito titoli')
            BackOffice.backToBackOffice()
        })
        it('AVIVA - Verifica apertura disambiguazione: Monitoraggio Guida Smart', function () {
            this.skip()
        ...
        it('AVIVA - Verifica apertura disambiguazione: Convenzioni in trattenuta', function () {
            this.skip()
            if (!Cypress.env('monoUtenza')) {
                TopBar.clickBackOffice()
        ...
        it('AVIVA - Verifica apertura disambiguazione: Impostazione contabilità', function () {
            TopBar.clickBackOffice()
