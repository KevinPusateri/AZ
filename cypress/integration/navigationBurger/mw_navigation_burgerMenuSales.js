...
if (Cypress.env('isAviva'))
    describe('AVIVA - Matrix Web : Navigazioni da Burger Menu in Sales', function() {
        ...
        it('AVIVA - Verifica aggancio Preventivo Motor', function() {
            TopBar.clickSales()
            BurgerMenuSales.clickLink('Preventivo Motor')
            BurgerMenuSales.backToSales()
        })

        it('AVIVA - Verifica aggancio Ultra Salute', function() {
            TopBar.clickSales()
            BurgerMenuSales.clickLink('Ultra Salute')
            BurgerMenuSales.backToSales()
        });

        it('AVIVA - Verifica aggancio Nuovo Sfera', function() {
        ...
        it('AVIVA - Verifica aggancio Campagne Commerciali', function() {
            if (!Cypress.env('monoUtenza')) {
                TopBar.clickSales()
        ...
        it('AVIVA - Verifica aggancio Recupero preventivi e quotazioni', function() {
            TopBar.clickSales()
        ...
        it('AVIVA - Verifica aggancio Documenti da firmare', function() {
            TopBar.clickSales()
            BurgerMenuSales.clickLink('Documenti da firmare')
            BurgerMenuSales.backToSales()
        })

        it('AVIVA - Verifica aggancio Monitoraggio Polizze Proposte', function() {
            TopBar.clickSales()
            BurgerMenuSales.clickLink('Monitoraggio Polizze Proposte')
            BurgerMenuSales.backToSales()
        })

        it('AVIVA - Verifica aggancio Certificazione fiscale', function() {
            TopBar.clickSales()
            BurgerMenuSales.clickLink('Certificazione fiscale')
            BurgerMenuSales.backToSales()
        })

        it('AVIVA - Verifica aggancio Manutenzione Portafoglio Auto', function() {
            TopBar.clickSales()
            BurgerMenuSales.clickLink('Manutenzione Portafoglio Auto')
            BurgerMenuSales.backToSales()
        })

        it('AVIVA - Verifica aggancio Documenti annullati', function() {
            TopBar.clickSales()
            BurgerMenuSales.clickLink('Documenti annullati')
            BurgerMenuSales.backToSales()
        })

        it('AVIVA - Verifica aggancio Documenti da gestire', function() {
            TopBar.clickSales()
            BurgerMenuSales.clickLink('Documenti da gestire')
            BurgerMenuSales.backToSales()
        })

        it('AVIVA - Verifica aggancio Folder', function() {
            TopBar.clickSales()
            BurgerMenuSales.clickLink('Folder')
            BurgerMenuSales.backToSales()
        })

        it('AVIVA - Verifica aggancio Qualità portafoglio auto', function() {
            TopBar.clickSales()
            BurgerMenuSales.clickLink('Qualità portafoglio auto')
            BurgerMenuSales.backToSales()
        })

        it('AVIVA - Verifica aggancio Note di contratto', function() {
            TopBar.clickSales()
