...
'coinvolti in completezza base e di tipo card 1 debitore ', () => {
    ...
    it('Lista polizze: Selezione della polizza', function () {
        ...
        cy.wait(1000);      
        Common.clickFindByIdOnIframeChild(IFrameParent, '#avantiListaPolizze'); 
        cy.wait(3000)     
    });
    ...
    it('Riepilogo denuncia - verifica dati danneggiato ', function () {
        ...
        //Common.getObjByTextOnIframeChild(IFrameParent, controparte_conducente_cognome + " " + controparte_conducente_nome);
        Common.getObjByIdAndTextOnIframeChild(IFrameParent, '#PRECOMMIT_listaDanneggiatiBUFF', controparte_targa);
    ...
    it('Riepilogo - Verifica dati di sinistro  ', function () {
        ...
        // il danneggiato 
        Common.getObjByTextOnIframeChild(IFrameParent, "Veicolo");
        Common.getObjByIdAndTextOnIframeChild(IFrameParent, '#PRECOMMIT_listaDanneggiatiBUFF',controparte_conducente_cognome + " " + controparte_conducente_nome);
        Common.getObjByIdAndTextOnIframeChild(IFrameParent, '#PRECOMMIT_listaDanneggiatiBUFF', controparte_targa);
        Common.getObjByIdAndTextOnIframeChild(IFrameParent, '#PRECOMMIT_listaDanneggiatiBUFF', tipo_danno);        
