...
var cliente_cognome = 'RAVAZIOL'
var cliente_nome = 'LUCA'
var cliente_dt_nascita = '27/01/197'
var cliente_num_pol = '78794150'
var cliente_targa = 'EW007YP'

var copertura_danno = 'INCENDIO'

var sinistro_veicoli_coinvolti = '1'
var sinistro_descrizione_danno = 'Combustione veicolo'
var sinistro_località = 'GORIZIA'

var tipo_danno = 'Incendio'

var carrozzeria_amica = 'ZORZI'
var carrozzeria_indirizzo ='Via T. Salsa, 3 - 31030 Carbonera'
var carrozzeria_telefono = '0422/398315'
var carrozzeria_email = 'Carrozzeria.Zorzi@Tiscali.It'
let dtAvvenimento
let dtDenuncia
...
' di garanzia la "' + copertura_danno + '" - Parziale con selezione della carrozzeria amica in fase di denucia', () => {
...
*/
    ...
    it('Elenco coperture - Prodotto Auto. Selezione della garanzia: '+copertura_danno, function () {              
        ...
        DenunciaSinistriPage.clickSelect_ById('#GARANZIE_parzialeTotale', "Parziale")
        cy.wait(1000);
    ...
    it('Selezione della Carrozzeria Amica: ' + carrozzeria_amica, function () {
        DenunciaSinistriPage.clickObj_ByLabel('td', carrozzeria_amica)
        cy.wait(500);
        cy.screenshot('Carrozzeria amica:  '+carrozzeria_amica, { clip: { x: 0, y: 0, width: 1920, height: 900 }, overwrite: true })
        DenunciaSinistriPage.clickObj_ByLabel('a', 'Seleziona')
        cy.wait(1000);
        cy.screenshot('Selezionata la carrozzeria amica', { clip: { x: 0, y: 0, width: 1920, height: 900 }, overwrite: true })
        cy.wait(1000);
    });
    
    it('Verifica dati della selezione della carozzeria Amica: '+carrozzeria_amica, function () {
        Common.getObjByIdAndTextOnIframeChild(IFrameParent, '#CFT_nomeCarrozzeriaAmica' , 'Carrozzeria'); 
        Common.getObjByIdAndTextOnIframeChild(IFrameParent, '#CFT_nomeCarrozzeriaAmica' , carrozzeria_amica);  
        Common.getObjByIdAndTextOnIframeChild(IFrameParent, '#CFT_indirizzoCarrozzeriaAmica' , carrozzeria_indirizzo);
        Common.getObjByIdAndTextOnIframeChild(IFrameParent, '#CFT_telefonoCarrozzeriaAmica' , carrozzeria_telefono);
        Common.getObjByIdAndTextOnIframeChild(IFrameParent, '#CFT_emailCarrozzeriaAmica' , carrozzeria_indirizzo);
        //Click Sul pulsante conferma definito erroneamente con lo stesso id del pulsante indietro
        let css_btn_conferma ='#workarea2 > fieldset.bottonNav > table > tbody > tr > td:nth-child(2) > a'
        Common.clickFindByIdOnIframeChild(IFrameParent,  css_btn_conferma);
        cy.wait(2000);
    });
    

    it('Verifica dei dati dei soggetti coinvolti nella lista riproposta in tabella ', function () {        
        Common.getObjByIdAndTextOnIframeChild (IFrameParent, '#DANNI_listaVeicoliSoggetti > div.k-grid-content', 'Contraente');   
        Common.getObjByIdAndTextOnIframeChild (IFrameParent, '#DANNI_listaVeicoliSoggetti > div.k-grid-content', cliente_cognome + " " +cliente_nome);             
        Common.getObjByIdAndTextOnIframeChild (IFrameParent, '#DANNI_listaVeicoliSoggetti > div.k-grid-content', cliente_targa)
    ...
    it('Riepilogo denuncia - verifica dati danneggiato ', function () {
       // il danneggiato
        ...
        Common.getObjByIdAndTextOnIframeChild(IFrameParent, '#PRECOMMIT_listaDanneggiatiBUFF', carrozzeria_telefono);    
    });
