...
export default class ListaAuto {
    ...
    constructor(tipo, targa, dataImmatricolazione) {
        this.tipo = tipo
        this.targa = targa
    ...
    static Auto_WW745FF(dataImmatricolazione) {
        ...
        let WW745FF = new ListaAuto("Auto", targa, dataImmatricolazione)
        WW745FF.targa = targa
        WW745FF.marca = "VOLVO"
        WW745FF.modello = "C70 (2005-2013)"
        WW745FF.versione = "C70 2.4 20V 170 CV MOMENTUM (DAL 2005/09)"
        WW745FF.dataImmatricolazione = json.dataConvenzione
        WW745FF.nPosti = "5"
    ...
    static Auto_ZZ841PP() {
        ...
        ZZ841PP.dataImmatricolazione = json.dataConvenzione
        ZZ841PP.nPosti = "5"
    ...
    static Moto_MM25896() {
        ...
        MM25896.dataImmatricolazione = json.dataConvenzione
        MM25896.nPosti = "2"
