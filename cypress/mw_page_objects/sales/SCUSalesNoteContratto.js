    ...
    static modificaNota() {
        ...
        cy.get('@iframe').within(() => {
            ...
            cy.get('table[role="grid"]').find('tbody > tr').first().within(() => {
                ...
                cy.screenshot('Modifica Nota Da Sales', { capture: 'fullPage' }, { overwrite: true })
                cy.get('ul').find('li:contains("Modifica nota")')
                    .click()
            })
            ...
            cy.get('form[class="editNota"]').should('be.visible').within(() => {
                ...
                cy.screenshot('Inizio Modifica Nota Da Sales', { capture: 'fullPage' }, { overwrite: true })
            ...
            cy.screenshot('Nota Da Sales Modificata', { capture: 'fullPage' }, { overwrite: true })
